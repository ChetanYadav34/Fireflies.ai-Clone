...
export default function SettingsemailassistantPage() {
  return (
    <div className="max-w-4xl w-full p-6 lg:p-10 pb-20">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 capitalize">email assistant</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Manage your email assistant settings here.
        </p>
      </div>
